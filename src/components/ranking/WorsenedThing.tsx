...
const WorsenedThing: React.FC<WorsenedThingProps> = ({
  ...
  return (
    <>
      {mode === WEEK_MODE ? (
        <div className="flex w-full whitespace-normal break-words items-center gap-2 self-stretch p-4 rounded-2xl bg-mind-boolan_bg text-label-normal text-base sm:text-lg md:text-xl font-medium shadow-sm">
          {weekBest ? (
        ...
        <div className="flex items-center gap-2 self-stretch p-4 rounded-2xl bg-mind-boolan_bg text-label-normal text-base sm:text-lg md:text-xl font-medium shadow-sm">
          {monthBest ? (
            <div className="w-full">
              <div>
                <Text as="span" variant="title2" color="label-normal">
